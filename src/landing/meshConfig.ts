...
export const FRACTAL_RESOLUTION = 512 * 8;
...
export const TRI_ALPHA = { min: 0.0, range: 0.9 };
...
export const BOUNDARY_FADE = 0.25;
...
// --- Fractal color texture (rendered to offscreen target, shader sourced from shaderRegistry) ---
